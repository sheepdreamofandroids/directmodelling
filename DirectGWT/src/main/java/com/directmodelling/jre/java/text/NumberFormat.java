...
public class NumberFormat implements Serializable {
	...
	protected NumberFormat(final com.google.gwt.i18n.client.NumberFormat format) {
		applyFormat(format);
	}
	...
	public final static NumberFormat getPercentInstance() {
		return new NumberFormat(
				com.google.gwt.i18n.client.NumberFormat.getPercentFormat());
	}
	...
	public final String format(final Object number) {
		if (number instanceof Number)
			return format.format((Number) number);
		else
