...
public class SwingCalculator {
  ...
  public SwingCalculator(
      final com.directmodelling.demo.shared.Calculator model, final DirectSwingInit init) {
    MODEL = model;
    this.init = init;
    init.init();
  }
  ...
  public static void main(final String[] args) {
    DirectSwingInit.INSTANCE.init();
    final SwingCalculator calc = DaggerSwingCalculator_Context.builder().build().calc();
    // Main.startup();
    calc.start();
  }
  ...
  public void bind(
      final CalculatorPanel panel, final com.directmodelling.demo.shared.Calculator model) {
    ...
    new Iterator2PanelBinding<DoubleValue>(
        panel.getCalculationList(),
        ...
        new Function<DoubleValue, Component>() {
          ...
          public Component apply(final DoubleValue in) {
            ...
            else return new OperatorCell(in);
